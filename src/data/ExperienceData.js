const ExperienceData = [
  {
    ...
    company: "Airnd",
    jobDesc: [
      "Design, implemented, built and maintained large and distributed, high availability micro-services",
      "Focused on quality with continuous integration and deployment",
      "Created testing strategies",
      "Participated in a wholesome approach to product development",
      "Drove the architecture, product backlog and timelines",
      `Embraced the challenges of dealing with, building and maintaining servers and applications that power all of our client's applications`,
      "Managed and optimized operations procedures while ensuring deployments were 100% automated"
    ],
  ...
  },
  {
    ...
    jobDesc: [
      ...
      "Familiarized myself with languages such as JavaScript (node.js) and Go."
    ],
